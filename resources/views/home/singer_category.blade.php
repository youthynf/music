...
<style>
	...
	.shenti .r{float:left; width:960px; height:400px;position: relative;}
...
<!--	    	<ul class="nav nav-pills nav-stacked">
    ...
    <div class="r">
        ...
        <ul class="list">
          <li><a href="{{url('/singer')}}/{{$singer->id}}"><img src="{{$singer->img}}" width="220" height="175"></a></li>
          <a href="#"><span class="text-success" style="font-size:16px;">{{$singer->name}}</span></a>   
      </ul>
      @endforeach
      <ul class="pagination pagination-sm no-margin pull-right" style="position: relative; bottom: -170px;">
